<?php
//-----------------------------------------------------//
// Remove unnesesary stuff from wp_head()
//-----------------------------------------------------//
...
//-----------------------------------------------------//
// Remove annoying WordPress admin notices and nags
//-----------------------------------------------------//
remove_action('admin_notices', 'woothemes_updater_notice'); // Remove WooCommerce Updater
